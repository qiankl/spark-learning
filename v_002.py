...
X_test, y_test = load_images('../food-101/test',30)
X_train, y_train = load_images('../food-101/train',100)
...
spark_model.fit(rdd, epochs=5, batch_size=5, verbose=1)
